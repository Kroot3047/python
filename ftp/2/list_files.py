...
print("{:20} {:19} {:7} {:5} {:4} {:5} {:4} {}".format("File Name", "Last Modified", "Size", "Perm","Type", "GRP", "MODE", "OWNER"))
for file_data in ftp.mlsd():
    ...
    # print all
    print(f"{file_name:20} {last_modified:19} {file_size:7} {permission:5} {file_type:5} ")
    #print(f"{file_name:20} {last_modified:18} {file_size:6} {permission:5} {file_type:4} {unix_group:4} {unix_mode:4} {unix_owner}")
